...
export default function Privacy() {
  ...
  return (
    <SitePage label="Confidentialité" title="Politique de Confidentialité" lead="Nous nous engageons à protéger vos données personnelles.">
      {loading ? (
        <div style={{ padding: '80px 0', display: 'flex', justifyContent: 'center' }}>
          <Loader message="Chargement de la politique de confidentialité..." />
        </div>
      ) : sections.length > 0 ? (
